...
Generell zeigt sich aber auch eine Schwankung die zeigt das Rust nicht durchgängig um ein Vielfaches besser dasteht. Vergleicht man gerade ProtoBuf das nur doppelt so schnell Serialisiert und Deserialisiert im Schnitt gegen z.B JSON und XML die um einen Faktor 7 nd 10 schneller sind sieht man dies deutlich.
