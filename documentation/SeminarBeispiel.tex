...
\textcolor{red}{Kann man hier eventuell oder in deinen Abschnitten davor noch coole Quellen zitieren oder so?}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{codegen_code.png}
...
\textcolor{red}{Python shit muss ich hier nochmal überarbeiten und kürzen viel unnötiges drin}
...
\subsection{Deserialisierung}

\subsection{Kompremierungsrate}
